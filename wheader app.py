...
class WeatherApp(QWidget):
    ...
    def get_weather(self):
        api_key = "1f4dc6841f902508f5759646401fc1d6"
        ...
        try: 
            ...
            match response.status_code:
                ...
                case 502:
                    self.display_error("Bad Getewawy :\nInvalid response from the server")
                case 503:
    ...
    def display_weather(self,data):
        ...
        self.emoji_label.setText(self.self_get_weather_emoji(weather_id))

        self.description_label.setText(weather_description)
    @staticmethod
    def self_get_weather_emoji(weather_id):
